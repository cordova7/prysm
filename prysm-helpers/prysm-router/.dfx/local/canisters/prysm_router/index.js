...
import { idlFactory } from './prysm_router.did.js';
export { idlFactory } from './prysm_router.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PRYSM_ROUTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./prysm_router.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the prysm_router canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./prysm_router.did.js")._SERVICE>}
 */
export const prysm_router = createActor(canisterId);
